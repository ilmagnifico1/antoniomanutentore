<section>
  ...
  <p>
    Il mio obiettivo e' fornire <strong>soluzioni rapide ed efficaci per ogni esigenza</strong>,
...
<section>
  ...
  <ul class="services-list">
    <li><span class="icon" aria-hidden="true">&#9889;</span> Manutenzione elettrica domestica</li>
    <li><span class="icon" aria-hidden="true">&#127912;</span> Tinteggiatura di interni e ritocchi murali</li>
    <li><span class="icon" aria-hidden="true">&#129521;</span> Montaggio di mensole e scaffalature</li>
    <li><span class="icon" aria-hidden="true">&#129682;</span> Montaggio e smontaggio mobili</li>
    <li><span class="icon" aria-hidden="true">&#128250;</span> Installazione a parete di TV e altri schermi</li>
    <li><span class="icon" aria-hidden="true">&#128295;</span> Ripristino e riparazione piccoli elettrodomestici</li>
    <li><span class="icon" aria-hidden="true">&#127744;</span> Riparazione aspirapolveri e piccoli apparecchi</li>
    <li><span class="icon" aria-hidden="true">&#127968;</span> Altri piccoli lavori domestici su richiesta</li>
  </ul>
</section>

<section>
  <h2>Perche' scegliermi</h2>
  <ul class="why-list">
    <li><span class="icon" aria-hidden="true">&#9989;</span> Massima serieta' e professionalita'</li>
    <li><span class="icon" aria-hidden="true">&#9201;</span> Interventi rapidi e puntuali</li>
    <li><span class="icon" aria-hidden="true">&#129504;</span> Soluzioni pratiche per ogni esigenza</li>
    <li><span class="icon" aria-hidden="true">&#128176;</span> Preventivi gratuiti e senza sorprese</li>
    <li><span class="icon" aria-hidden="true">&#129309;</span> Chiarezza e disponibilita' verso il cliente</li>
  </ul>
</section>
